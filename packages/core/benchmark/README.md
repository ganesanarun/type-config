...
|----------|---------|-------------|-------------|-------------|
| Small config (basic) | ~8.8k | 0.11ms | 0.13ms | 0.19ms |
| Medium config (50 sections) | ~6.4k | 0.16ms | 0.17ms | 0.22ms |
| Large config (200 sections) | ~2.7k | 0.37ms | 0.38ms | 0.43ms |
| Config value retrieval | >3.6M | <0.001ms | <0.001ms | <0.001ms |
| Typed container access | >6.3M | <0.001ms | <0.001ms | <0.001ms |
...
**Note:** Results vary based on hardware and system load. Run benchmarks on your target hardware for accurate measurements.
...
|--------|---------|----------|
| Container access (typed) | 6.3M | ✅ **Recommended** - Production code |
| Direct path access | 3.6M | ⚠️ Dynamic/runtime access only |
